(function ()
{
    ...
    function fuseGenerator(fuseTheming)
    {
        ...
        function render(styleVars)
        {
            ...
            styleEl.appendChild(document.createTextNode(themeStyle));
