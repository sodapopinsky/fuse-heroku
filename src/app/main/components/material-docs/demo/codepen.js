(function ()
{
    ...
    {
        var angularMaterialVersion = window.ngMaterial.version.full;

        // The following URL's need to use `localhost` as these values get replaced during release
        var CORE_JS = 'https://ajax.googleapis.com/ajax/libs/angular_material/' + angularMaterialVersion + '/angular-material.min.js';
        var CORE_CSS = 'https://ajax.googleapis.com/ajax/libs/angular_material/' + angularMaterialVersion + '/angular-material.min.css';
        var DOC_CSS = '';              // CSS overrides for custom docs
